                                                                <!-- ADD RECORD FORM - Get Data To Write To File -->
...
<head>
    ...
    <meta name="description" content="A form user can use to enter information and add to the file">
...
<body>
    <form method="post">
        <h1 class="text-center">Adding Record</h1><hr>
        ...
        <fieldset class="form-group">
            <div class="row">
            <label for="type" class="col-sm-2 col-form-label">Brand: </label>
            <div class="col-sm-10">
        ...
        <?php
            // Only append to file when all inputs are validated
            if($validInputs) {
                echo '<script>alert("Record has been successfully added!");
                location.href="main.php";</script>';
                add_record_to_file($type, $brand, $model, $size, $o_price, $s_price, $description);
            }
        ?>
    </form>
    <hr>
